...
```ts file=../../../tests/multi-tokens-support.test.mjs start=startBasicNilJSExample end=endBasicNilJSExample
```

To burn an existing token:

```ts file=../../../tests/multi-tokens-support.test.mjs start=startNilJSBurningExample end=endNilJSBurningExample
```

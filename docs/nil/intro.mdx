...
<CardSection>
    ...
    <Card id='getting-started' title='Getting started' description='Learn how to perform essential operations on the cluster' to='https://docs.nil.foundation/nil/getting-started/essentials/creating-a-smart-account'/>
</CardSection>

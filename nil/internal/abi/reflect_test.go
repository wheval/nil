...
func TestReflectNameToStruct(t *testing.T) { //nolint:tparallel
	t.Parallel()

	for _, test := range reflectTests { //nolint:paralleltest
...
func TestConvertType(t *testing.T) {
	...
	// ConvertType
	out := *ConvertType(val.Interface(), new(T)).(*T) //nolint:forcetypeassert
	...
	out2 := *ConvertType(val2.Interface(), new([]T)).(*[]T) //nolint:forcetypeassert
	...
	out3 := *ConvertType(val3.Interface(), new([2]T)).(*[2]T) //nolint:forcetypeassert

...
type (
	...
	IsValidValidatorDelegate     func(*proto.IbftMessage) bool
	isProposerDelegate           func([]byte, uint64, uint64) bool
	buildEthereumBlockDelegate   func(uint64) []byte
	isValidProposalHashDelegate  func(*proto.Proposal, []byte) bool
...
type (
	buildPrepareMessageDelegate     func([]byte, *proto.View) *proto.IbftMessage
	buildCommitMessageDelegate      func([]byte, *proto.View) *proto.IbftMessage
...
type (
	insertProposalDelegate func(*proto.Proposal, []*messages.CommittedSeal)
	idDelegate             func() []byte
	getVotingPowerDelegate func(uint64) (map[string]*big.Int, error)
)
...
// Define delegation methods
type opLogDelegate func(string, ...any)

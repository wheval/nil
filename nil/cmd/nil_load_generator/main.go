...
func main() {
	...
	rootCmd.Flags().StringVar(&cfg.MintTokenAmount0, "mint-token-amount0", "3000000", "mint amount for token0")
	rootCmd.Flags().StringVar(&cfg.MintTokenAmount1, "mint-token-amount1", "10000", "mint amount for token1")

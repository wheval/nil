...
func (api *ShardApiAccessor) GetTokens(ctx context.Context, address types.Address, blockReference rawapitypes.BlockReference) (map[types.TokenId]types.Value, error) {
	return sendRequestAndGetResponseWithCallerMethodName[map[types.TokenId]types.Value](ctx, api, "GetTokens", address, blockReference)
}
...
func (api *ShardApiAccessor) GetInTransaction(ctx context.Context, request rawapitypes.TransactionRequest) (*rawapitypes.TransactionInfo, error) {
	return sendRequestAndGetResponseWithCallerMethodName[*rawapitypes.TransactionInfo](ctx, api, "GetInTransaction", request)
}

func (api *ShardApiAccessor) GetInTransactionReceipt(ctx context.Context, hash common.Hash) (*rawapitypes.ReceiptInfo, error) {
	return sendRequestAndGetResponseWithCallerMethodName[*rawapitypes.ReceiptInfo](ctx, api, "GetInTransactionReceipt", hash)
}
